                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <div style="position:relative;">
                            <input class="form-control" type="password" id="reg_owner_password" name="owner_password" required style="padding-right:2.8rem;">
                            <button type="button" onclick="toggleRegPassword()" tabindex="-1"
                                style="position:absolute;right:10px;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;color:#888;padding:4px;">
                                <svg id="regPasswordEye" xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function toggleRegPassword() {
    const input = document.getElementById('reg_owner_password');
    const icon  = document.getElementById('regPasswordEye');
