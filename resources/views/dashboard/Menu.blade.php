...
<div class="menu-grid">
    ...
    <div class="card-dark">
        <h2>Add Item</h2>
        <form method="POST" action="/dashboard/{{ $restaurant->id }}/menu/item" id="addItemForm">
            @csrf
...
<div class="menu-category">
    ...
    <div class="category-header">
        <h2 style="color:#f3f4f6;">{{ $cat->name }}</h2>
        <span style="font-size:12px;color:#6b7280;">{{ $cat->items->count() }} items</span>
    </div>
    ...
    <div class="items-grid">
        ...
        <div class="item-card">
            ...
            <div class="item-bottom">
                ...
                <div class="actions">
                    <form method="POST"
                          action="{{ route('dashboard.toggle-item', [$restaurant->id, $item->id]) }}">
                        @csrf
                    ...
                    <form method="POST"
                          action="{{ route('dashboard.delete-item', [$restaurant->id, $item->id]) }}"
