...
<title>Login — <?php echo e($r->name); ?></title>
...
<div class="page">
    ...
    <div class="right">
        ...
        <form method="POST" action="/dashboard/<?php echo e($r->id); ?>/login">
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Seeb\restaurant-bot\restaurant-bot\resources\views/dashboard/login.blade.php ENDPATH**/ ?>