...
<head>
    ...
    <title><?php echo e($restaurant->name ?? 'Dashboard'); ?></title>
    <style>
...
<nav>
    <div class="nav-left">
        <span class="brand">🍽️ <?php echo e($restaurant->name); ?></span>
        <div class="nav-links">
            <a href="/dashboard/<?php echo e($restaurant->id); ?>/orders"
               class="nav-link <?php echo e(request()->routeIs('dashboard.orders') ? 'active' : ''); ?>">
                Orders
            </a>
            <a href="/dashboard/<?php echo e($restaurant->id); ?>/menu"
               class="nav-link <?php echo e(request()->routeIs('dashboard.menu') ? 'active' : ''); ?>">
                Menu
            </a>
            <a href="/dashboard/<?php echo e($restaurant->id); ?>/settings"
    ...
    <div class="nav-right">
        <span class="open-badge <?php echo e($restaurant->is_open ? 'badge-open' : 'badge-closed'); ?>">
            <?php echo e($restaurant->is_open ? '● Open' : '● Closed'); ?>

        </span>
        <form method="POST" action="/dashboard/<?php echo e($restaurant->id); ?>/logout" style="display:inline;">
            <?php echo csrf_field(); ?>
...
<div class="body">
    <?php if(session('success')): ?>
        <div class="success-bar">✓ <?php echo e(session('success')); ?></div>
    <?php endif; ?>
...
</html><?php /**PATH C:\Users\Seeb\restaurant-bot\restaurant-bot\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>